...
bool OptionsManager::parse(int argc_par, char** argv_par) {
    ...
    if (in_file.IsNull()) {
        ...
        if (out_file.IsNull())
            out_file = "POL_HK_decoded_data_L1.root";
        return true;
    }
}
...
void OptionsManager::print_help() {
    cout << "Usage:" << endl;
    cout << "  " << SW_NAME << " " << "<POL_HK_decoded_data.root> [-o <POL_HK_decoded_data_L1.root>]" << endl;
    cout << endl;
    cout << "Options:" << endl;
...
void OptionsManager::print_version() {
    cout << endl;
    cout << "    " << SW_NAME << " - POLAR HK decoded data Level 1 converting" << endl;
