...
This project was initially started on GitHub ([github.com/ZhenghengLi/POLAR_RawData_Decode_Project](https://github.com/ZhenghengLi/POLAR_RawData_Decode_Project)) as opensource, then moved to private(Bitbucket then GitLab) on 28th August 2016 due to involving confidential information which is mainly about the decoding of the platform parameters data from TG-2
