...
bool RecEventDataFile::open(const char* filename, char m) {
    ...
    if (is_first_created_) {
        t_rec_event_tree_->Branch("abs_gps_week",    &t_rec_event.abs_gps_week,    "abs_gps_week/I"        );
        t_rec_event_tree_->Branch("abs_gps_second",  &t_rec_event.abs_gps_second,  "abs_gps_second/D"      );
        t_rec_event_tree_->Branch("abs_gps_valid",   &t_rec_event.abs_gps_valid,   "abs_gps_valid/O"       );
        t_rec_event_tree_->Branch("abs_ship_second", &t_rec_event.abs_ship_second, "abs_ship_second/D"     );
        ...
        t_rec_event_tree_->SetBranchAddress("abs_gps_week",    &t_rec_event.abs_gps_week    );
        t_rec_event_tree_->SetBranchAddress("abs_gps_second",  &t_rec_event.abs_gps_second  );
        t_rec_event_tree_->SetBranchAddress("abs_gps_valid",   &t_rec_event.abs_gps_valid   );
        t_rec_event_tree_->SetBranchAddress("abs_ship_second", &t_rec_event.abs_ship_second );
