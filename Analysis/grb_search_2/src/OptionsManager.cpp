...
void OptionsManager::print_help() {
    cout << "Usage:" << endl;
    cout << "  " << SW_NAME << " <decoded_data_file.root> [-B <week1:second1>] [-E <week2:second2>] [-o <filename.pdf>]" << endl;
    cout << "  ";
    for (size_t i = 0; i < SW_NAME.length(); i++)
        cout << " ";
    cout << " [-s <min_signif>] [-y <min_bars>] [-z <max_bars>] [-k <bar_mask.cfg]" << endl;
    cout << endl;
    cout << "Options:" << endl;
    ...
    cout << "  -s <min_signif>                  minimum significance level" << endl;
