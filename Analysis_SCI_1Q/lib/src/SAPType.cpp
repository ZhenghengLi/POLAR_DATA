...
void SAPType::deactive_all(TTree* t_pol_event_tree) {
    t_pol_event_tree->SetBranchStatus("*", false);
}

void SAPType::deactive(TTree* t_pol_event_tree, const char* branch_name) {
    t_pol_event_tree->SetBranchStatus(branch_name, false);
}

void SAPType::active_all(TTree* t_pol_event_tree) {
    t_pol_event_tree->SetBranchStatus("*", true);
}

void SAPType::active(TTree* t_pol_event_tree, const char* branch_name) {
