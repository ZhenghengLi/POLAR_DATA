...
bool OptionsManager::parse(int argc_par, char** argv_par) {
    ...
    if (na22_flag_filename.IsNull()) {
        na22_flag_filename = "na22_flag.root";
    }
    return true;
}
...
void OptionsManager::print_help() {
    cout << "Usage:" << endl;
    cout << "  " << SW_NAME << " <SCI_1Q.root> [-o <na22_flag.root>]" << endl;
    cout << endl;
    cout << "Options:" << endl;
    cout << "  -o <na22_flag.root>              root file to store Na22 flag info" << endl;
    cout << endl;
