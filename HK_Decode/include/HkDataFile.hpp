...
public:
    struct Hk_Obox_T {
        ...
        UShort_t       ct_temp;                       // raw data of Central Trigger temperature
        ...
        UChar_t        fe_temp[25];                   // raw data of module temperature
        UShort_t       fe_hv[25];                     // raw data of HV voltage setting
        UShort_t       fe_thr[25];                    // raw data of threshold setting
        UShort_t       fe_rate[25];                   // raw data of count rate
        UShort_t       fe_cosmic[25];                 // raw data of too many / too high rate 
        UShort_t       flex_i_p3v3[5];                // raw data of Current at P3V3 rail
        UShort_t       flex_i_p1v7[5];                // raw data of Current at P1V7 rail
        UShort_t       flex_i_n2v5[5];                // raw data of Current at N2V5 rail
        UShort_t       flex_v_p3v3[5];                // raw data of Voltage at P3V3 rail
        UShort_t       flex_v_p1v7[5];                // raw data of Voltage at P1V7 rail
        UShort_t       flex_v_n2v5[5];                // raw data of Voltage at N2V5 rail
        UShort_t       hv_v_hot;                      // raw data of Voltage at HV Hot P3V3 rail
        UShort_t       hv_i_hot;                      // raw data of Current at HV Hot P3V3 rail
        UShort_t       ct_v_hot[2];                   // raw data of Voltage at CT Hot P3V3 and 1V5 rail
        UShort_t       ct_i_hot[2];                   // raw data of Current at CT Hot P3V3 and 1V5 rail
        UShort_t       hv_v_cold;                     // raw data of Voltage at HV Cold P3V3 rail
        UShort_t       hv_i_cold;                     // raw data of Current at HV Cold P3V3 rail
        UShort_t       ct_v_cold[2];                  // raw data of Voltage at CT Cold P3V3 and 1V5 rail
        UShort_t       ct_i_cold[2];                  // raw data of Current at CT Cold P3V3 and 1V5 rail
